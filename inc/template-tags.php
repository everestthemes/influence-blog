	...
	function influence_blog_posted_by( $display_meta ) {
        ...
        if( true == $display_meta ) {
            ...
            $byline = sprintf(
                ...
                esc_html_x( 'by %s', 'post author', 'influence-blog' ),
...
if ( ! function_exists( 'influence_blog_post_thumbnail' ) ) :
	...
	function influence_blog_post_thumbnail() {
		...
		$display_featured_image = true;
            ...
            if( is_home() ) {
                $display_featured_image = ifb_mod( 'blog_page_display_featured_image', true );
            }
            
            if( is_archive() ) {
                $display_featured_image = ifb_mod( 'archive_page_display_featured_image', true );
            }
            
            if( is_search() ) {
                $display_featured_image = ifb_mod( 'search_page_display_featured_image', true );
            }
