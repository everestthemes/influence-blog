...
if ( !function_exists( 'influence_blog_defaults' ) ) {
	...
	function influence_blog_defaults( $theme_mod ) {
		...
		$defaults = array(
            ...
            'footer_one_widget_area_advance_d_p_top' => 0,
            'footer_one_widget_area_advance_d_p_right' => 0,
            'footer_one_widget_area_advance_d_p_bottom' => 0,
            'footer_one_widget_area_advance_d_p_left' => 0,
            ...
            'footer_two_design_widget_content_bg_color' => '',
            'footer_two_design_widget_content_bg_hover_color' => '',
            'footer_two_design_widget_content_border_color' => '',
            ...
            'footer_two_widget_area_advance_d_p_top' => 0,
            'footer_two_widget_area_advance_d_p_right' => 0,
            'footer_two_widget_area_advance_d_p_bottom' => 0,
            'footer_two_widget_area_advance_d_p_left' => 0,
