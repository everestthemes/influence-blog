...
$button_one_array = array(
    'influence_blog_archivepage_layout_options_select_heading' => array(),
    'influence_blog_archivepage_layout_options_select' => array(),
);
...
$wp_customize->add_control( new Influence_Blog_Tab_One_Control( $wp_customize, 'influence_blog_archivepage_layout_options_tabs', array(
    'section'                  => $section,
    'tabs'                     => $option_tabs,
    'controls'                 => array(
...
$wp_customize->add_control( new Influence_Blog_Heading_One_Control( $wp_customize, 'influence_blog_archivepage_layout_options_select_heading', array(
...
$wp_customize->add_control( new Influence_Blog_Radio_Image_Two_Control( $wp_customize, 'influence_blog_archivepage_layout_options_select', array(
    'section'                  => $section,
