...
if( ! class_exists( 'Influence_Blog_Repeater_One_Control' ) ) {
    ...
    class Influence_Blog_Repeater_One_Control extends WP_Customize_Control {
    	...
    	public function repeater_js_template() {
    		...
    		<script type="text/html" class="customize-control-repeater-content">
    			...
    			<li class="repeater-row minimized" data-row="{{{ index }}}">
    				...
    				<div class="repeater-one-row-header">
    					<span class="repeater-one-row-label"></span>
    					<i class="dashicons dashicons-arrow-down repeater-minimize"></i>
    				</div>
    				<div class="repeater-one-row-content">
    					<# _.each( data, function( field, i ) { #>

    						<div class="repeater-field repeater-one-field-{{{ field.type }}}">
        ...
        function get_icon_list(){
    	    $icons = include wp_normalize_path( get_template_directory() . '/inc/customizer/controls/repeater/repeater-one/fontawesome/fontawesome.php' );
            if( $icons ){ ?>
