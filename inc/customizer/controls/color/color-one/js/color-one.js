...
jQuery( document ).ready( function( $ ) {
	...
	$( '.color-one-control' ).each( function() {
		...
		colorPickerOptions = {
			...
			palettes: colorOne.colorPalettes // Use the passed in palette.
		};
		...
		$( '<div class="color-one-picker-container">' +
		...
		$( '.iris-picker, .color-one-control' ).on( 'click', function(e) {
			e.preventDefault();
		});
