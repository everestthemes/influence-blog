...
( function( $ ) {
    ...
    c( 'influence_blog_footer_one_design_widget_area_title_alignment', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_design_widget_area_title_alignment">.foot-top-border .widget .side-tt { text-align: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_design_widget_title_color', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_design_widget_title_color">.foot-top-border .side-tt .s-title { color: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_design_widget_title_bg_color', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_design_widget_title_bg_color">.foot-top-border .widget-title { background-color: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_design_widget_content_hover_color', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_design_widget_content_hover_color">.foot-top-wrap .widget a:hover, .foot-top-wrap .widget ul li a:hover, .foot-top-wrap .widget_tag_cloud .tagcloud a:hover { color: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_design_widget_content_bg_color', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_design_widget_content_bg_color">.foot-top-wrap .widget_tag_cloud .tagcloud a { background-color: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_design_widget_content_border_color', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_design_widget_content_border_color">.foot-top-wrap .calendar_wrap table th, .foot-top-wrap .widget_tag_cloud .tagcloud a, .foot-top-wrap .widget_product_tag_cloud .tagcloud a { border: 1px solid ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_design_widget_content_border_color', function( value ) {
        value.bind( function( to ) {
            var $child = $( '.customizer-influence_blog_footer_one_design_widget_content_border_color' );
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_design_widget_content_border_color">.foot-top-wrap .widget.widget_recent_entries li, .foot-top-wrap .widget.widget_recent_comments li, .foot-top-wrap .widget.widget_meta li { border-bottom: 1px solid ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_m_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_m_top">.foot-top-border .side-tt.widget-title { margin-top: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_m_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_m_right">.foot-top-border .side-tt.widget-title { margin-right: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_m_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_m_bottom">.foot-top-border .side-tt.widget-title { margin-bottom: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_m_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_m_left">.foot-top-border .side-tt.widget-title { margin-left: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_m_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_m_top">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { margin-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_m_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_m_right">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { margin-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_m_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_m_bottom">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { margin-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_m_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_m_left">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { margin-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_m_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_m_top">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { margin-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_m_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_m_right">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { margin-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_m_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_m_bottom">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { margin-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_m_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_m_left">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { margin-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_p_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_p_top">.foot-top-border .side-tt.widget-title { padding-top: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_p_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_p_right">.foot-top-border .side-tt.widget-title { padding-right: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_p_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_p_bottom">.foot-top-border .side-tt.widget-title { padding-bottom: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_d_p_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_d_p_left">.foot-top-border .side-tt.widget-title { padding-left: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_p_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_p_top">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { padding-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_p_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_p_right">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { padding-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_p_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_p_bottom">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { padding-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_t_p_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_t_p_left">@media (max-width: 768px) { .foot-top-border .side-tt.widget-title { padding-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_p_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_p_top">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { padding-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_p_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_p_right">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { padding-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_p_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_p_bottom">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { padding-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_one_widget_title_advance_m_p_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_one_widget_title_advance_m_p_left">@media (max-width: 480px) { .foot-top-border .side-tt.widget-title { padding-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_design_widget_area_title_alignment', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_design_widget_area_title_alignment">.footer-mid-sec .widget-title { text-align: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_design_widget_title_color', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_design_widget_title_color">.footer-mid-sec .widget-title .s-title { color: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_design_widget_title_border_color', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_design_widget_title_border_color">.footer-mid-sec .widget-title .s-title { border-bottom-color: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_transform', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_transform">.footer-mid-sec .widget-title .s-title { text-transform: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_size_d', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_size_d">.footer-mid-sec .widget-title .s-title { font-size: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_size_t', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_size_t">@media (max-width: 768px) { .footer-mid-sec .widget-title .s-title { font-size: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_size_m', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_size_m">@media (max-width: 480px) { .footer-mid-sec .widget-title .s-title { font-size: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_height_d', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_height_d">.footer-mid-sec .widget-title .s-title { line-height: ' + to + '; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_height_t', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_height_t">@media (max-width: 768px) { .footer-mid-sec .widget-title .s-title { line-height: ' + to + '; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_height_m', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_height_m">@media (max-width: 480px) { .footer-mid-sec .widget-title .s-title { line-height: ' + to + '; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_spacing_d', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_spacing_d">.footer-mid-sec .widget-title .s-title { letter-spacing: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_spacing_t', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_spacing_t">@media (max-width: 768px) { .footer-mid-sec .widget-title .s-title { letter-spacing: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_typo_footer_two_widget_area_design_title_spacing_m', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_typo_footer_two_widget_area_design_title_spacing_m">@media (max-width: 480px) { .footer-mid-sec .widget-title .s-title { letter-spacing: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_m_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_m_top">.footer-mid-sec .widget .side-tt.widget-title { margin-top: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_m_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_m_right">.footer-mid-sec .widget .side-tt.widget-title { margin-right: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_m_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_m_bottom">.footer-mid-sec .widget .side-tt.widget-title { margin-bottom: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_m_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_m_left">.footer-mid-sec .widget .side-tt.widget-title { margin-left: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_m_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_m_top">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { margin-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_m_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_m_right">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { margin-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_m_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_m_bottom">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { margin-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_m_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_m_left">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { margin-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_m_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_m_top">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { margin-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_m_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_m_right">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { margin-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_m_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_m_bottom">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { margin-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_m_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_m_left">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { margin-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_p_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_p_top">.footer-mid-sec .widget .side-tt.widget-title { padding-top: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_p_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_p_right">.footer-mid-sec .widget .side-tt.widget-title { padding-right: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_p_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_p_bottom">.footer-mid-sec .widget .side-tt.widget-title { padding-bottom: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_d_p_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_d_p_left">.footer-mid-sec .widget .side-tt.widget-title { padding-left: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_p_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_p_top">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { padding-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_p_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_p_right">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { padding-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_p_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_p_bottom">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { padding-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_t_p_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_t_p_left">@media (max-width: 768px) { .footer-mid-sec .widget .side-tt.widget-title { padding-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_p_top', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_p_top">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { padding-top: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_p_right', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_p_right">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { padding-right: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_p_bottom', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_p_bottom">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { padding-bottom: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_m_p_left', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_m_p_left">@media (max-width: 480px) { .footer-mid-sec .widget .side-tt.widget-title { padding-left: ' + to + 'px; } }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
    ...
    c( 'influence_blog_footer_two_widget_title_advance_border_width', function( value ) {
        value.bind( function( to ) {
            ...
            if ( to ) {
                var style = '<style class="customizer-influence_blog_footer_two_widget_title_advance_border_width">.footer-mid-sec .widget .side-tt .s-title { border-bottom-width: ' + to + 'px; }</style>';
                if ( $child.length ) {
                    $child.replaceWith( style );
                } else {
                    $( 'head' ).append( style );
