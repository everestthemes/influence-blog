...
$breadcrumb = infb_blog_get_mod( 'searchpage_content_options_breadcrumb_toggle' );

$sidebar_position = infb_blog_get_mod( 'searchpage_content_options_sidebar_position' );

$sidebar_area = infb_blog_get_mod( 'searchpage_content_options_widget_area_select' );
