        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                if( $banner_query -> have_posts() ) {
                    ...
                    $slider_col = ifb_get_mod( 'banner_content_options_two_slider_col' );
                ...
                $display_ads = ifb_get_mod( 'banner_content_options_two_ads_toggle' );

                if( $display_ads ) {

                    $ads_col = ifb_get_mod( 'banner_content_options_two_ads_col' );
                    ...
                    <div class="col-12 <?php echo esc_attr( $col_class ); ?>">
                        <div class="banner-post">
                            <div class="banner-wrapper">
                                <?php
                                $ads_image = ifb_get_mod( 'banner_content_options_two_ads_upload_image' );
                                ...
                                <div class="slide"<?php influence_blog_has_image_url( $ads_image_id_src[0] ); ?>>
                                    <div class="banner-caption">
                                        <?php
                                        $ads_title = ifb_get_mod( 'banner_content_options_two_ads_title' );
                                        $ads_link = ifb_get_mod( 'banner_content_options_two_ads_link' );

                                        $rel_tag = '';

                                        $tab_class = '_self';

                                        $ads_link_rel = ifb_get_mod( 'banner_content_options_two_ads_link_rel' );
                                        ...
                                        $ads_link_tab = ifb_get_mod( 'banner_content_options_two_ads_link_tab_toggle' );
